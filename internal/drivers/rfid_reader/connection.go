...
// connectTCP creates a TCP connection to the reader
func connectTCP(address string, port int, logger *telemetry.Logger) (Connection, error) {
	addr := fmt.Sprintf("%s:%d", address, port)

	logger.Debug("connecting to RFID reader via TCP",
...
// connectSerial creates a serial connection to the reader
func connectSerial(device string, baudRate int, logger *telemetry.Logger) (Connection, error) {
	logger.Debug("connecting to RFID reader via serial",
...
// serialConnection implements Connection for serial
