...
// findUSBDevice finds and opens a USB HID scanner on macOS
func findUSBDevice(config Config) (USBDevice, error) {
	...
	// Note: macOS handles USB driver detachment differently
	// SetAutoDetach is not needed and may cause issues
	// The system automatically manages HID drivers
